module "ecs-cluster" {
  source  = "registry.terraform.io/cn-terraform/ecs-cluster/aws"
  version = "1.0.9"
...
locals {
  ...
  container_list_raw = [
    module.container-django-app-gunicorn.json_map_object,
    module.container-nginx.json_map_object
  ]
}
...
module "td" {
  ...
  containers = local.container_list_raw
